...
var TweenloopInterval = require('../utils/tween-loop-interval');
...
AudioMediaObject.prototype.makeElement = function(callback) {
    callback();
};

AudioMediaObject.prototype.onReady = function(callback) {
    callback();
};
